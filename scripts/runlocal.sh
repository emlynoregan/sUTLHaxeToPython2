...
python "$1/munge_haxe_python3_to_python2.py" < "$1/sUTLHaxePython2/sUTLTests3.py" > "$1/sUTLHaxePython2/sUTLTests2.py" || { echo '040' ; exit 1; }
rm "$1/sUTLHaxePython2/sUTLTests3.py" || { echo '042' ; exit 1; }
python "$1/sUTLHaxePython2/sUTLTests2.py" || { echo '045' ; exit 1; }

#3: Generate the python interpreter
/usr/bin/haxe build.hxml || { echo '050' ; exit 1; }
python "$1/munge_haxe_python3_to_python2.py" < "$1/sUTLHaxePython2/sUTL3.py" > "$1/sUTLHaxePython2/sUTL2.py" || { echo '055' ; exit 1; }
rm "$1/sUTLHaxePython2/sUTL3.py" || { echo '057' ; exit 1; }
